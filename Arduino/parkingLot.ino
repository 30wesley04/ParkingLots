...
void loop() {
  Firebase.getInt(firebaseData, "/Estacionamiento/Angelopolis/Secciones/A/spaces");
  ...
  if (spacesChanged != 0) {
    if (currentSpaces >= spacesChanged) {
      Firebase.setInt(firebaseData, "/Estacionamiento/Angelopolis/Secciones/A/spaces", currentSpaces - spacesChanged);
